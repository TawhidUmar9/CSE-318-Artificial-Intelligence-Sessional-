...
int main()
{
  std::cerr << "C++ Agent: Starting execution\n";
  ...
  std::cerr << "C++ Agent: Header parsed: " << last_mover_type << "\n";
  ...
  if (last_mover_type == "Human")
  {
    ...
    std::cerr << "C++ Agent: Human move at (" << human_row << "," << human_col << ")\n";
  }
